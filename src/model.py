...
def get_model_fn(num_classes):
    ...
    def model_fn(features, labels, mode):
        ...
        # on CPU. The exception is Intel MKL on CPU which is optimal with channel_last
        ...
        for i in range(num_devices):
            ...
            if VARIABLE_STRATEGY == "CPU":
                ...
                device_setter = utils.local_device_setter(
                    ...
                    ps_strategy = tf.contrib.training.GreedyLoadBalancingStrategy(GPU_COUNT,
        ...
        if mode == "train" or mode == "eval":
          ...
          with tf.device(consolidation_device):
               ...
               predictions = {
                   ...
                   "probabilities":tf.concat([p["probabilities"]
...
def input_fn(dataset_dir, split_name, is_training):
    ...
    with tf.device("/cpu:0"):
        ...
        image_batch, _, label_batch = dataset_utils.load_batch(dataset, BATCH_SIZE, IMAGE_SIZE,
        ...
        # number of epochs, but the dataset repeats forever.
...
def get_experiment_fn(dataset_dir):
    """Return the experiment function given a dataset_dir"""
