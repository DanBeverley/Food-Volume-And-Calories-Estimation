...
class ExamplePerSecondHook(session_run_hook.SessionRunHook):
    ...
    def __init__(self, batch_size, every_n_steps=100, every_n_secs = None):
        ...
        assert (every_n_steps is not None) != (every_n_secs is not None) ,\
            ValueError("Exactly one of every_n_steps and every_n_specs should be provided")
